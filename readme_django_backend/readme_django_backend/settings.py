...
SECRET_KEY = 'django-insecure-89bj@ktcotogl2#kx(w7xhs(-h2*u_!e(d!pkr2a88x(p7j!om'
...
ROOT_URLCONF = 'readme_django_backend.urls'
...
WSGI_APPLICATION = 'readme_django_backend.wsgi.application'
